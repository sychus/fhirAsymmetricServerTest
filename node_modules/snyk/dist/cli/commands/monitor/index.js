...
function detectInspectMonitor(path, options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
        ...
        return {
            ok: false,
            data: new errors_1.MonitorError(500, 'Failed to monitor path.'),
            path,
        };
    });
}
...
function monitor(...args0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const results = yield Promise.all(args.map((arg) => detectInspectMonitor(arg, options)));
